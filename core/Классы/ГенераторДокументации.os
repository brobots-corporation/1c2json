...
Процедура ПриСозданииОбъекта()
	...
	Лог = Логирование.ПолучитьЛог("oscript.1с2json.generator");

КонецПроцедуры

Процедура ОбработатьФайлы(Знач Настройки) Экспорт

	Сообщить("Каталог исходников %1" + Настройки.КаталогИсходников);
	Сообщить("Выходной каталог %1" + Настройки.ВыходнойКаталог);
